...
namespace UnityEditor
{
	internal class UVFreePBRShaderGUI : ShaderGUI
	{
		...
		void DoSpecularMetallicArea()
		{
			...
			{
				if (specularMap.textureValue == null) //if the texture value is null
				...
				else //if the texture value is NOT null (it has a map) the original code has this turning off a bunch of properties!
					m_MaterialEditor.TexturePropertySingleLine(Styles.specularMapText, specularMap);//this is the original code...
					//m_MaterialEditor.TexturePropertyTwoLines(Styles.specularMapText, specularMap, specularColor, Styles.smoothnessText, smoothness);// JEFF i edited this to be like the above... including other properties.
